...
protected:
  ...
  void CompleteForkOnCookie(Ptr <Packet>, const TcpHeader& , const Address&, const Address&);
  ...
  void SendEmptySynAckPacket (const TcpHeader&, const Address&, const Address& ) ; //Send an empty SYN | ACK packet
  ...
  void ProcessSynSent (Ptr<Packet>, const TcpHeader&, const Address&, const Address&); // Received a packet upon SYN_SENT
  void ProcessSynRcvd (Ptr<Packet>, const TcpHeader&, const Address&, const Address&); // Received a packet upon SYN_RCVD

  void ProcessSynRcvdCookie ( Ptr<Packet>, const TcpHeader&, const Address&, const Address&);//Recived an ACK in Listen State 
...
//Generates the SynCookie based on the IP + Port + Timestamp 
  uint32_t generateSynCookie (const TcpHeader& , const Address& , const Address& );
